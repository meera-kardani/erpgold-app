frappe.ui.form.on('Purchase Invoice Item', {
    ...
    custom_labour_type_: function (frm, cdt, cdn) {
    ...
    custom_labour_amount_: function (frm, cdt, cdn) {
        calculateTotalAmount(frm, cdt, cdn);
    }
});
...
function calculateLabourAmount(frm, cdt, cdn) {
    var child = locals[cdt][cdn];
    var labourType = child.custom_labour_type_;
    ...
    frappe.model.set_value(cdt, cdn, 'custom_labour_amount_', labourAmount);
}
...
function calculateTotalAmount(frm, cdt, cdn) {
    ...
    var labourAmount = child.custom_labour_amount_ || 0;
